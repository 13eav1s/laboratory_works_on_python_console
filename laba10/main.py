...
realValue = anDer(stop) - anDer(start)
...
print("Абсолютная погрешность для метода трапецый : ", abs(realValue - Trapezoid(start, stop, N1)))
print("Абсолютная погрешность для метода буля : ", abs(realValue - Bull(start, stop, N1)))
